# 🚀 Event Yangu - Supabase Setup Guide

This guide will help you set up the complete Supabase backend for Event Yangu with migrations, seeders, and best practices.
...
- ❌ Don't skip testing in local environment
